...
import edu.uidaho.electricblocks.blocks.SimpleBlock;
...
import edu.uidaho.electricblocks.items.SimpleItem;
...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> SIMPLE_ITEM = ITEMS.register("simple_item", SimpleItem::new);
